...
7. `Cloudflare名錄與影像館登入維護指引.md`：涉及社員區、Email 白名單、Cloudflare Access、登入故障或復原時必讀。
8. `人物頁模板化規格與檢查清單.md`：新增或修改人物頁時必讀。
9. `網站結構優化建議報告書.md`：做架構、資料化、模板化、導覽擴張時參考。
...
- 導覽維持 8 項扁平架構：最新消息、關於、傳承、編號、人物誌、校友聯演、名錄、影像館；網站名稱「嘉中管樂」另作首頁入口。新增第一層導覽前需重新評估架構。
