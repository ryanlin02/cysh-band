...
const ARCHIVE_INTROS = {
  ...
  '2011-27th': '第 27 屆聯合音樂會目前可由活動指定曲資料夾 README 補入 9 首曲目，包含《Perseus》、《Carnival》、《Concerto for Clarinet》、《Rhapsody in Blue》與《Tico-Tico no Fuba》等作品。日期暫列 2011 年 7 月 16 日；場地、指揮、正式主題與完整團員名單仍待節目冊、海報或校友補充資料確認。',
