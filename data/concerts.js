...
window.CONCERTS = [
  ...
  },
  {
    ...
    venueNote: "今嘉義市政府文化局音樂廳",
    hostHead: "",
    metaDescription: "2006 年第 22 屆國立嘉義高中管樂團校友暨在校生聯合音樂會《爵士音樂 絕世音樂》完整紀錄：8 月 26 日於嘉義市文化中心音樂廳演出，由顏崇勝指揮、8301 高崇文客席指揮，8861 簡晟軒擔任長號獨奏。",
    ...
    programBook: [
      { src: "assets/img/concerts/2006-program/page-01.webp", caption: "2006 年第 22 屆《爵士音樂 絕世音樂》節目冊封面" },
    ...
    status: "confirmed",
    notes: "2006 年第 22 屆《爵士音樂 絕世音樂》的日期、時間、場地、免費入場、指揮、客席指揮、長號獨奏、曲目、演出成員、人物介紹、演出單位、贊助與致謝均已確認。"
  },
  {
    id: "2005-21st",
    nth: 21,
